  ...
  return (
    <div className={styles.aDetailContent}>
      ...
      <div className={styles.aBar}>
        <Link href="/app" className={styles.aBarBack} aria-label="홈으로 돌아가기">
      ...
      <div className={styles.aEasyRow}>
        <div className={styles.aEasy}>
          ...
          <span className={styles.aEasyLabel}>날씨</span>
          <span className={styles.aEasyValue}>{beach.sky} {beach.air}℃</span>
        </div>
        <div className={styles.aEasy}>
          <Icon
            name="uv"
          ...
          />
          <span className={styles.aEasyLabel}>자외선</span>
          <span className={styles.aEasyValue}>{beach.uv}</span>
        </div>
        <div className={styles.aEasy}>
          <Icon
            name="crowd"
          ...
          />
          <span className={styles.aEasyLabel}>혼잡도</span>
          <span className={styles.aEasyValue}>{beach.crowd}</span>
        </div>
      </div>

      {/* 근처 주차장 보기 버튼 */}
      <a href="#" className={styles.aParkBtn} aria-label={`${beach.parking} 주차장 보기`}>
      ...
      <div className={styles.aDetailSecH}>해양 안전 분석</div>
      <AppOceanPanel
        wave={beach.wave}
        tide={beach.tide}
